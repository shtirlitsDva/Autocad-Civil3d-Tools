...
namespace DriPaletteSet
{
    public partial class PipePalette : UserControl
    {
        ...
        private const float BaseButtonHeight = 32f;
        private const float BaseFontPt = 9f;
        private int pad = 20;
        ...
        private void PipePalette_Load(object sender, EventArgs e)
        {
            ...
            Font font = new Font("Microsoft Sans Serif", BaseFontPt);
            float fontHeight;
            ...
            float btnHght = BaseButtonHeight * dpiScalingFactor;
            float fontHght = BaseFontPt * dpiScalingFactor;
            #endregion
            ...
            labelButton = new Button()
            {
                ...
                Dock = DockStyle.Fill,
                Font = new Font("Arial", fontHght, FontStyle.Bold),
                ForeColor = Color.DarkBlue,
                BackColor = Color.LightGray,
                FlatAppearance = { BorderSize = 0 },
                Height = (int)Math.Ceiling(btnHght),
            };
            ...
            widthManagementTLP.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
        ...
        private void ComboBox_PipeTypeSelector_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                currentComb.Type == PipeTypeEnum.Enkelt)
            {
                ...
                typeTLP.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
            ...
            PopulateButtons(listDns, 4, tblPnl, dnButtonCheckBox_Click, dnCheckBoxes);
            gpBox.Height = tblPnl.Height + pad + (int)Math.Ceiling(fontHeight);
            #endregion
        }
            ...
            List<string> buttonsData, int colCount, TableLayoutPanel tLP, EventHandler clickEventHandler, List<CheckBox> checkBoxes)
        {
            ...
            for (int i = 0; i < rowCount && dataIndex < buttonsData.Count(); i++)
            {
                for (int j = 0; j < colCount && dataIndex < buttonsData.Count(); j++)
                {
                    CheckBox chk = new CheckBox
                    {
                        ...
                        BackColor = Color.LightGray,
                        ForeColor = Color.DarkBlue,
                        Font = new Font("Arial", BaseFontPt * dpiScalingFactor, FontStyle.Bold),
            ...
            tLP.Parent.Height = rowCount * ((int)Math.Round(btnHght)) + 10;
        }
