...
namespace SheetCreationAutomation.ViewModels
{
    public partial class ViewFramesAutomationViewModel : ObservableObject
    {
        ...
        private readonly IViewFrameAutomationRunner automationRunner;
        ...
        private async Task StartScript()
        {
            ...
            try
            {
                ...
                var progress = new Progress<string>(message => LastStatus = message);
                ...
                else
                {
                    ...
                    {
                        Utils.prdDbg(failureMessage);
                        if (!string.IsNullOrWhiteSpace(result.Failure.SelectorSnapshot))
                        {
                            Utils.prdDbg(result.Failure.SelectorSnapshot);
                        }
                    }
                }
            }
