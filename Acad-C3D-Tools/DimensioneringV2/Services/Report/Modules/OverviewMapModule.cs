...
/// <summary>
/// Stub for §9 Oversigtskort — not yet implemented.
/// </summary>
internal class OverviewMapModule : IReportModule
{
    public ReportModuleId Id => ReportModuleId.OverviewMap;
    public string DisplayName => "Oversigtskort";
