...
{
    public class PipeAluPexFL : PipeBase
    {
        public PipeAluPexFL(double roughness_mm) : base(roughness_mm) { }
        protected override string Name => "PipeAluPexFL";
        protected override PipeType PipeType => PipeType.AluPEXFL;
        ...
        public override string ToString() => "AluPEX";
    }
}
