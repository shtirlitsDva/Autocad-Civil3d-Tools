    ...
    public static class MissingAssemblyLoader
    {
        ...
        public static Assembly? Debug_AssemblyResolve(object? sender, ResolveEventArgs args)
        {
            string assemblyFolder = 
                @"X:\GitHub\shtirlitsDva\Autocad-Civil3d-Tools\Acad-C3D-Tools\NTRExport\bin\Debug";
            string sendersname = sender?.GetType().Name ?? "Unknown";
            prdDbg($"{sendersname} asked for assembly: {args.Name}!");
