...
public class FreezeLERPointLayersOp : OperationBase
{
    public override string TypeId => "Viewport.FreezeLERPointLayers";
    public override string DisplayName => "Freeze LER Point Layers";
    public override string Description =>
        "Finds all ProfileProjectionLabel layers and freezes them in the viewport matching the specified center coordinates.";
        ...
        IReadOnlyDictionary<string, object> parameterValues)
    {
        ...
        HashSet<ProfileProjectionLabel> labels =
            context.Database.HashSetOfType<ProfileProjectionLabel>(xTx);
