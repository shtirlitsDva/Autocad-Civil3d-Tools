...
public class CreatePipeProfileReferencesOp : OperationBase
{
    public override string TypeId => "DataShortcut.CreatePipeProfileRefs";
    public override string DisplayName => "Create Pipe Profile References";
    public override string Description => "Creates data shortcut references for pipe profiles matching alignments in the drawing.";
