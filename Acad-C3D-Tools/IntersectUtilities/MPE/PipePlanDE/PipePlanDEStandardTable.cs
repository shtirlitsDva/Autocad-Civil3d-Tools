...
{
    // Columns: z1, z3, d, x, z2, z4, b, b1, B, B1
    private static readonly PipePlanDEStandardRow[] _rows =
    [
        Row(25,  "25/90",     0.20, 0.20, 0.09, 0.20, 0.20, 0.20, 0.78, 0.78, 0.90, 1.10),
        Row(32,  "32/110",    0.20, 0.20, 0.11, 0.20, 0.20, 0.20, 0.82, 0.82, 0.95, 1.15),
        Row(40,  "40/110",    0.20, 0.20, 0.11, 0.20, 0.20, 0.20, 0.82, 0.82, 0.95, 1.15),
        Row(50,  "50/125",    0.20, 0.20, 0.13, 0.20, 0.20, 0.20, 0.86, 0.86, 0.95, 1.15),
        Row(65,  "65/140",    0.20, 0.20, 0.14, 0.20, 0.20, 0.20, 0.88, 0.88, 1.00, 1.20),
        Row(80,  "80/160",    0.20, 0.20, 0.16, 0.20, 0.20, 0.20, 0.92, 0.92, 1.05, 1.25),
        Row(100, "100/200",   0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 1.00, 1.00, 1.10, 1.30),
        Row(125, "125/225",   0.20, 0.20, 0.23, 0.20, 0.20, 0.40, 1.26, 1.21, 1.35, 1.50),
        Row(150, "150/250",   0.20, 0.20, 0.25, 0.20, 0.20, 0.40, 1.30, 1.25, 1.40, 1.55),
        Row(200, "200/315",   0.20, 0.20, 0.32, 0.20, 0.20, 0.40, 1.44, 1.39, 1.55, 1.70),
        Row(250, "250/400",   0.20, 0.20, 0.40, 0.20, 0.20, 0.40, 1.60, 1.55, 1.70, 1.85),
        Row(300, "300/450",   0.40, 0.35, 0.45, 0.35, 0.40, 0.35, 2.05, 1.19, 2.15, 2.25),
        Row(350, "350/500",   0.40, 0.35, 0.50, 0.35, 0.40, 0.35, 2.15, 2.05, 2.25, 2.35),
        Row(400, "400/560",   0.40, 0.35, 0.56, 0.35, 0.40, 0.35, 2.27, 2.17, 2.40, 2.50),
        Row(450, "450/630",   0.40, 0.35, 0.63, 0.35, 0.40, 0.35, 2.41, 2.31, 2.50, 2.60),
        Row(500, "500/670",   0.40, 0.35, 0.67, 0.35, 0.40, 0.35, 2.49, 2.39, 2.60, 2.70),
        Row(600, "600/800",   0.40, 0.35, 0.75, 0.35, 0.40, 0.35, 2.75, 2.65, 2.85, 2.95),
    ];
