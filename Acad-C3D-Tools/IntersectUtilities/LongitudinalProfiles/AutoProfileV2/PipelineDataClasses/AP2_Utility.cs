...
namespace IntersectUtilities.LongitudinalProfiles.AutoProfileV2
{
    internal class AP2_Utility : PipelineDataBase
    {
        ...
        /// </summary>        
        public AP2_Utility(Geometry envelope, double station, AP2_PipelineData pipeline) : base(pipeline)
        {
        ...
        public Arc BuildExtendedAvoidanceArc(double radius)
        {
            ...
            var surfaceElevation = _pipeLine.SurfaceProfile.GetSurfaceElevationAtStation(this.MidStation);
        ...
        internal Polyline BuildHorizontalArcPolylineWithTrimmedArcs(double startStation, double endStation)
        {
            ...
            var surfaceElevation = _pipeLine.SurfaceProfile.GetSurfaceElevationAtStation(startStation);
            ...
            surfaceElevation = _pipeLine.SurfaceProfile.GetSurfaceElevationAtStation(endStation);
