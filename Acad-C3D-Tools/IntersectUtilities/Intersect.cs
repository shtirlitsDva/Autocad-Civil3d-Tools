...
namespace IntersectUtilities
{
    public partial class Intersect : IExtensionApplication
    {
        ...
        public void importptwithps()
        {
            ...
            #region Read CSV headers to get column names
            ...
            try
            {
                    ...
                    new Microsoft.VisualBasic.FileIO.TextFieldParser(csvFilePath))
                {
                    ...
                    {
                        prdDbg("CSV file is empty or missing header row.");
                        return;
                    }
                }
            }
            ...
            try
            {
                ...
                {
                    (Point3d coordinates, Action<Entity> attachAction) = importer.GetNextRow();

                    // Create DBPoint at coordinates
                    DBPoint dbPoint = new DBPoint(coordinates);
                    ...
                    // Attach PropertySet and populate data
