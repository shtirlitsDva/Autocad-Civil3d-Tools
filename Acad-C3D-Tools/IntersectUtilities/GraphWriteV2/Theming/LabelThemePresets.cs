...
public static class LabelThemePresets
{
    ...
    public static ThemeColors Colors(PalettePreset p) => p switch
    {
        PalettePreset.Cyan => new ThemeColors
        {
            ...
            Chip1 = "#38bdf8", Chip2 = "#fbbf24", Chip3 = "#f472b6", ChipText = "#04121a",
        ...
        PalettePreset.Amber => new ThemeColors
        {
            ...
            Chip1 = "#56c2ff", Chip2 = "#a3e635", Chip3 = "#fb7185", ChipText = "#1a1305",
        ...
        PalettePreset.Emerald => new ThemeColors
        {
            ...
            Chip1 = "#2dd4bf", Chip2 = "#facc15", Chip3 = "#fb7185", ChipText = "#04130b",
        ...
        PalettePreset.Violet => new ThemeColors
        {
            ...
            Chip1 = "#c084fc", Chip2 = "#f0abfc", Chip3 = "#67e8f9", ChipText = "#160a22",
    ...
    public static LabelTheme Default() => new()
    {
        ...
        Series = new SeriesStyle { Show = true, Fill = ChipFill.Filled, Pos = ChipPos.After },
        Fonts = new FontSet { Id = "Courier New", Body = "Helvetica" },
        Padding = 9,
        Rounded = true,
    };
}
